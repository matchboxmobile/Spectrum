...
public interface class IhelloworldConsumer
{
    event Windows::Foundation::TypedEventHandler<helloworldConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<helloworldConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<helloworldConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class helloworldConsumer sealed  : [Windows::Foundation::Metadata::Default] IhelloworldConsumer
{
public:
    helloworldConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    ...
    static Windows::Foundation::IAsyncOperation<helloworldJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ helloworldWatcher^ watcher);

    // Call the MethodOne method
    Windows::Foundation::IAsyncOperation<helloworldMethodOneResult^>^ MethodOneAsync(_In_ int32 interfaceMemberInput);
    // Get the value of the PropertyOne property.
    Windows::Foundation::IAsyncOperation<helloworldGetPropertyOneResult^>^ GetPropertyOneAsync();

    // Set the value of the PropertyOne property.
    Windows::Foundation::IAsyncOperation<helloworldSetPropertyOneResult^>^ SetPropertyOneAsync(_In_ bool value);
    ...
    virtual event Windows::Foundation::TypedEventHandler<helloworldConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<helloworldConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<helloworldConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
